...
if ( ! function_exists( 'orto_woocommerce_get_css' ) ) {
	add_filter( 'orto_filter_get_css', 'orto_woocommerce_get_css', 10, 2 );
	function orto_woocommerce_get_css( $css, $args ) {
...
$fdir = orto_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}